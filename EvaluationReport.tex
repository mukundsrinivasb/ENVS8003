...
% Companies like Meta, Apple, Amazon, Google, Nvidia, Samsung, and Dell are 
% at the forefront of this, with their adaptation strategies requiring close examination. Since no universal 
% framework exists specifically for evaluating climate responses within the tech sector, established climate 
% change metrics must be applied. This report systematically analyzes the sustainability efforts of these companies, 
% focusing on their core operations, climate-related risks, and adaptation measures. Using the scorecard provided by 
% the International Institute for Environment and Development (Craft and Fisher, 2016), alongside the evaluation 
% framework by Jones (2001), we assess how these tech giants align their policies with global sustainability goals.
